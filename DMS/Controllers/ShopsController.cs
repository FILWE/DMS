...
namespace DMS.Controllers
{
    public class ShopsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ShopID,Name,Contact")] Shop shop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ShopID,Name,Contact")] Shop shop)
        {
            if (id != shop.ShopID)
            {
                return NotFound();
