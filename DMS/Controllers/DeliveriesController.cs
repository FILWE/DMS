...
namespace DMS.Controllers
{
    public class DeliveriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DeliveryID,ShopID,Stock,DeliveryDate,Quantity")] Delivery delivery)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DeliveryID,ShopID,Stock,DeliveryDate,Quantity")] Delivery delivery)
        {
